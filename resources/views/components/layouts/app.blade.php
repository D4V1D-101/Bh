...
<footer class="section-sm bg-tertiary">
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-2 col-md-4 col-6 mb-4">
                <div class="footer-widget">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a wire:navigate class="nav-link" href="{{route('home')}}">Home</a></li>
                        <li class="mb-2"><a href="{{route('page',1)}}" wire:navigate>About Us</a></li>
                        <li class="mb-2"><a wire:navigate class="nav-link" href="{{route('servicesPage')}}">Games</a></li>
            ...
            <div class="col-lg-2 col-md-4 col-6 mb-4">
                <div class="footer-widget">
                    <h5 class="mb-4 text-primary font-secondary"></h5>
                    <ul class="list-unstyled">
                        <li class="mb-2"> <a wire:navigate class="nav-link" href="{{ route('teamPage') }}">Our Team</a></li>
                        <li class="mb-2"><a wire:navigate class="nav-link " href="{{ route('blog') }}">News</a></li>
                        <li class="mb-2"><a wire:navigate class="nav-link " href="{{ route('faqs') }}">Faq</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6 mb-4">
                <div class="footer-widget">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="list-inline-item me-4"><a class="text-black" href="{{route('page',3)}}" wire:navigate>Terms &amp; Conditions</a></li>
                    </ul>
                </div>
            </div>
        </div>
